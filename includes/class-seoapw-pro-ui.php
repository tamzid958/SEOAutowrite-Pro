		...
		switch ( $type ) {
			case 'zero_balance':
				return sprintf(
					...
					__( '🔴 <strong>SEOAutowrite Pro:</strong> Your balance is $0.00. This article was generated by Ollama. <a href="%s" target="_blank">Top Up Now</a> to resume SEOAutowrite AI generation.', 'seoapw' ),
					$top_up_url
				);
