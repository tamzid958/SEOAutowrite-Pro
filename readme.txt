...
= 1.1.0 =
* Remove: dropped manual load_plugin_textdomain() call; WordPress 4.6+ auto-loads translations via plugin header.
...
= 1.1.0 =
Minor maintenance release. Safe to update — no database changes or reactivation required.
